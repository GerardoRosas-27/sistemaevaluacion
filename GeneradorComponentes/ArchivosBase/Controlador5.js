...
function cargarComponente_RemNomSubCar() {
    ...
    switch (accion) {
        ...
        case 'agregar_RemNomComp3':
            ...
            break;
        case 'mostrar_RemNomComp4':
            $('#cont_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp4/Tabla_RemNomComp4.html');
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp4/Tabla_RemNomComp4.js?n=1");

            break;
        case 'agregar_RemNomComp4':
            $('#cont_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp4/Formulario_RemNomComp4.html');
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp4/Formulario_RemNomComp4.js?n=1");

            break;
        case 'mostrar_RemNomComp5':
            $('#cont_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp5/Tabla_RemNomComp5.html');
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp5/Tabla_RemNomComp5.js?n=1");

            break;
        case 'agregar_RemNomComp5':
            $('#cont_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp5/Formulario_RemNomComp5.html');
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp5/Formulario_RemNomComp5.js?n=1");
        ...
        case 'ambos_RemNomSubCar':
            ...
            $('#contOculto_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp4/Formulario_RemNomComp4.html', function (data7) {
                $('#cont_RemNomSubCar').append(data7);
            });
            $('#contOculto_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp4/Tabla_RemNomComp4.html', function (data8) {
                $('#cont_RemNomSubCar').append(data8);
            });
            
             $('#contOculto_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp5/Formulario_RemNomComp5.html', function (data9) {
                $('#cont_RemNomSubCar').append(data9);
            });
            $('#contOculto_RemNomSubCar').load('_RemNomDirect/_RemNomSubCar/_RemNomComp5/Tabla_RemNomComp5.html', function (data10) {
                $('#cont_RemNomSubCar').append(data10);
            });
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp1/Formulario_RemNomComp1.js?n=1");
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp1/Tabla_RemNomComp1.js?n=1");
            $.getScript("_RemNomDirect/_RemNomSubCar/_RemNomComp2/Formulario_RemNomComp2.js?n=1");
